    ...
    <>
      <ScrollView style={[y.bgColor('#fff')]}>
        ...
        <View style={[y.bb(8), y.pa(20), y.bdColor('#f0f2f5')]}>
          ...
          <View style={[y.uac, y.mt(20)]}>
            <Image
              style={[y.size(70), y.mb(17)]}
              source={require('../images/个人主页/lock1.png')}/>
            <Text style={[y.fSize(14), y.color('#333'), y.fWeight('bold')]}>Ta设置了相册锁</Text>
            <Text style={[y.fSize(10), y.color('#999'), y.mt(8)]}>有12张照片，其中1张为红包照片</Text>
            <LinearGradient
              start={{x: 0, y: 0}}
              end={{x: 1, y: 1}}
              colors={['#FFC1A3', '#F1628D']}
              style={[y.radiusA(20), y.h(40), y.plr(22), y.mt(18), y.uac, y.ujc]}
            >
              <Text style={[y.color('#fff'), y.fSize(15)]}>解锁Ta(25桃花币)，会员免费</Text>
            </LinearGradient>
          </View>
        </View>
        <View style={[y.bb(8), y.pa(20), y.bdColor('#f0f2f5')]}>
