  ...
  return (
    <>
      <ScrollView style={[y.bgColor('#fff')]}>
        ...
        <View style={[y.bb(8), y.pa(20), y.bdColor('#f0f2f5')]}>
          <Text style={[y.color('#333'), y.fSize(15), y.fWeight('bold')]}>心愿</Text>
          <View
            style={[y.bgColor('#FFB1A4'), y.udr, y.uac, y.ujb, y.ptb(8), y.pl(18), y.pr(12), y.radiusA(5), y.mt(9)]}>
            <View>
              <View style={[y.udr, y.uac]}>
                <Image style={[y.size(17)]} source={require('../images/个人主页/poto1.png')}/>
                <Text style={[y.fSize(12), y.ml(6), y.color('#fff')]}>照片一张</Text>
              </View>
              <View style={[y.udr, y.uac, y.mt(4)]}>
                <Image style={[y.size(17)]} source={require('../images/个人主页/mgift.png')}/>
                <Text style={[y.fSize(12), y.ml(6), y.color('#fff')]}>x 3</Text>
              </View>
            </View>
            <View style={[y.bgColor('#F85766'), y.h(21), y.w(62), y.radiusA(11), y.ujc, y.uac]}>
              <Text style={[y.color('#fff'), y.fSize(12), y.fStyle('italic')]}>
                满足Ta
              </Text>
            </View>
          </View>
